...
| `routeLineColor` | `#00838f` | Colour of the route line - teal, the colour the barbs use as well. It is a setting of its own: change it and the barbs keep theirs. Clear it to use AvNav's route colour. |
